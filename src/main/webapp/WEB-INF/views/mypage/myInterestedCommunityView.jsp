...
<head>
<meta charset="UTF-8">
<title>내가 관심있는 커뮤니티</title>
<!-- CSS only -->
<style>
	#myInterestedComunityView {
		margin-top: 50px;
		padding: 40px;
		width:1400px;
	}
...
<jsp:include page="../common/top.jsp" />
	<div id="myInterestedComunityView" class="container">
		<h3 style="color:#CD5C5C;">내가 관심있는 커뮤니티</h3><br><br><br>
		<c:if test="${ empty list  }">
        	<div class="alert alert-danger" role="alert" id="table">아직 관심있는 모임이 없습니다.</div>
    	</c:if>
    	<c:if test="${ !empty list }">
