			...
			<div class="position-sticky pt-3">
				<ul class="nav flex-column">
          			...
          			<li class="nav-item">
			            ...
			            <a class="nav-link active" aria-current="page" href="${contextPath }/manageHangout.ad">
							<span data-feather="home"></span>
							모임게시판 관리
			            </a>
          			</li>
		...
		<tbody>
			<c:forEach var="h" items="${ hList }">
				<tr>
					...
					<td>${h.boardId }</td>
					<td>${h.boardWriter }</td>
					<td><a href="<c:url value='/hangoutDetail.ha?boardId=${h.boardId}&writer=${h.boardWriter }'/>">${h.boardTitle }</a></td>
					<td>${h.modifyDate }</td>
				</tr>
			</c:forEach>
		</tbody>
